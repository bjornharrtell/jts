...
public class UnaryUnionOp 
{
	...
	private void extract(Geometry geom)
	{
		...
		*/
		GeometryExtracter.extract(geom, Geometry.ORDINAL_POLYGON, polygons);
		GeometryExtracter.extract(geom, Geometry.ORDINAL_LINESTRING, lines);
		GeometryExtracter.extract(geom, Geometry.ORDINAL_POINT, points);
	}
